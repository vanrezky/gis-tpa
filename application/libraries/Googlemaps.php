...
class Googlemaps
{
    ...
    var $apiKey                        = 'AIzaSyAK2hEI0hiioyqRWGBYGDork_37mBM2mmg';                         // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
    ...
    var $center                        = "0.575207,101.4290535";        // Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
    ...
    var $minzoom                    = '5';                        // The minimum zoom level which will be displayed on the map
    var $maxzoom                    = '25';                        // The maximum zoom level which will be displayed on the map
