...
class Home extends MY_Controller
{
    ...
    public function visi_misi()
    {
        ...
        $this->view('home/v_home_visi_misi', $data, true);
    }
    ...
    public function persebaran($id = "")
    {
        ...
        foreach ($tps as $value) {
            ...
            $status = status_tps_pilih($value['status']);

            $HTML .= "<div class='media' data-status='$value[status]'>";
            ...
            $HTML .= "<li>Kapasitas, $value[kapasitas]</li>";
            ...
            $marker['status_tps'] = $value['status'];
            $HTML = "";
        ...
        $this->view('home/v_home_persebaran', $data);
    }
