            ...
            <form role="form" method="post" id="submit-form" action="<?= base_url(isset($tps['id_tps']) ? 'admin/tps/update/' . encode($tps['id_tps']) : 'admin/tps/save') ?>">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Kapasitas (Dalam Kilogram)</label>
                            <input type="number" class="form-control" id="kapasitas" name="kapasitas" value="<?= isset($tps['kapasitas']) ? $tps['kapasitas'] : ""; ?>">
                            <div class="invalid-feedback" id="feedkapasitas"></div>
                        </div>
                        <div class="form-group">
                            <label>Telp</label>
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="custom-select">
                                <option value="">Pilih</option>
                                <?php
                                foreach (status_tps() as $key => $value) {
                                    $s = isset($tps['status']) ? ($tps['status'] == $key ? "selected" : "") : "";

                                    echo "<option value='$key' $s>$value</option>";
                                }
                                ?>
                            </select>
                            <div class="invalid-feedback" id="feedstatus"></div>
                        </div>
                ...
                success: function(response) {
                    ...
                    if (response.error) {
                        ...
                        if (response.error.kapasitas) {
                            ...
                            $('#feedkapasitas').html(response.error.kapasitas);
                        } else {
                        ...
                        if (response.error.status) {
                            ...
                            $('#feedstatus').html(response.error.status);
                        } else {
