<section class="breadcrumb_area">
    ...
    <div class="container">
        <div class="page-cover text-center">
            ...
            <ol class="breadcrumb">
               asd <li><a href="<?= base_url(); ?>">Home</a></li>
...
<script>
    ...
    function findClosestN(pt, numberOfResults) {
        ...
        for (i = 0; i < markers_map.length; i++) {
            ...
            var content = markers_map[i].content;
            var status_tps = $(content).data("status");
            // console.log(status_tps);
            // var statusTps = markers_map[i].closest(".media").data("status");
            ...
            markers_map[i].status_tps = status_tps;
        ...
        service.getDistanceMatrix(request, function(response, status) {
            if (status != google.maps.DistanceMatrixStatus.OK) {
                ...
                for (var i = 0; i < closest.length; i++) {
                    ...
                    results[i].status_tps = closest[i].status_tps;
                }
    ...
    function tampilkan(terdekat) {
        ...
        $.each(terdekat, function(indexInArray, valueOfElement) {
            ...
            let position = valueOfElement.tpsLatLng;
            let status_tps_tampil = valueOfElement.status_tps;
            ...
            if (status_tps_tampil == 2) {
                html += '<a href="javascript:void(0)" class="genric-btn warning radius small">Penuh</a>';
            } else {
