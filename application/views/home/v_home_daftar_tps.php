            ...
            <div class="col-lg-8">
                <div class="blog_left_sidebar">
                    ...
                    <?php endforeach;
                        ...
                        echo "<h3>Yang anda cari tidak ditemukan..</h3>";
                    }
                    ?>
                    <?= $pagin; ?>
                </div>
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    <aside class="single_sidebar_widget search_widget">
                        <form action="<?= base_url("daftar-tps"); ?>" method="GET">
                            <div class="input-group">

                                <input type="text" name="s" value="<?= $s; ?>" class="form-control" placeholder="Cari TPS">
