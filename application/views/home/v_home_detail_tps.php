                 ...
                 <div class="single-post row">
                     ...
                     <div class="col-lg-3  col-md-3">
                         <div class="blog_info text-right">
                             <ul class="rute-list">
                                 <li><a id="btn-persebaran" data-status="<?= $data['status']; ?>" href="<?= base_url('persebaran/' . encode($data['id_tps'])); ?>" class="genric-btn danger radius">Cari Rute</a></li>
                             </ul>
                             ...
                             <table class="table table-bordered">
                                 <tbody>
                                     ...
                                     <tr>
                                         <td>Status</td>
                                         <td class="text-center">:</td>
                                         <td><?= status_tps_pilih($data['status']); ?></td>
                                     </tr>
                                     <tr>
                                         <td>Created At</td>
                                         <td class="text-center">:</td>
 ...
 <script>
     $(document).ready(function() {
         ...
         $("#btn-persebaran").click(function(e) {
             e.preventDefault();
             let status = $(this).data("status");
             let href = $(this).prop("href");

             if (status == 2) {
                 Swal.fire("Opps..", "TPS ini sudah penuh!", "warning");
                 return false;
             }
