...
<script src="<?= base_url('assets/frontend/'); ?>vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.js"></script>
<script src="<?= base_url('assets/frontend/'); ?>vendors/nice-select/js/jquery.nice-select.js"></script>
<script src="<?= base_url('assets/frontend/'); ?>js/mail-script.js"></script>
