...
function tgl_jam_indo($tgl, $time = true)
{
    $bulan = array(
        1 =>   'Januari',
        'Februari',
...
function status_tps_pilih($status = "")
{

    switch ($status) {
        case '1':
            $return = "<a href='javascript:void(0)' class='badge badge-success'>Tersedia</a>";
            break;
        case '2':
            $return = "<a href='javascript:void(0)' class='badge badge-warning'>Penuh</a>";
            break;
